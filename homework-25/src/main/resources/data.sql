merge into users (id, username, password, authority) values (1, 'user', 'user', 'ROLE_USER');
merge into users (id, username, password, authority) values (2, 'admin', 'admin', 'ROLE_ADMIN, ROLE_USER');
merge into users (id, username, password, authority) values (3, 'superuser', 'superuser', 'ROLE_TERMINATOR, ROLE_USER, ROLE_ADMIN');
