CREATE TABLE IF NOT EXISTS USERS(ID LONG PRIMARY KEY AUTO_INCREMENT, USERNAME VARCHAR(500) not null unique, PASSWORD VARCHAR(500) not null, AUTHORITY VARCHAR(500) not null);
