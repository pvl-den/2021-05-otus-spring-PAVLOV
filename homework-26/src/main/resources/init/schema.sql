CREATE TABLE IF NOT EXISTS AUTHORS(ID LONG PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(500) not null, MONGO_ID VARCHAR(500));

CREATE TABLE IF NOT EXISTS GENRES(ID LONG PRIMARY KEY AUTO_INCREMENT, NAME VARCHAR(500) not null unique, MONGO_ID VARCHAR(500));
